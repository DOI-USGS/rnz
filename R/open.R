...
#'  pizzarr zarrs backend, in either Zarr v2 or v3, and must publish
#'  consolidated metadata: a `.zmetadata` key on v2, or a
#'  `consolidated_metadata` member of the root `zarr.json` on v3. Connection
