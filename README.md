...
[`RNetCDF`](https://cran.r-project.org/package=RNetCDF); Zarr access is
delegated to [`pizzarr`](https://github.com/keller-mark/pizzarr). Code
...
[NZ-1.0 convention](https://github.com/zarr-conventions/nz/) — the
structural layer that puts [NetCDF Users
Guide](https://docs.unidata.ucar.edu/nug/current/) (NUG) semantics on
...
The example below opens the bundled BCSD demo store and exercises the
full inquiry/read API against it:
